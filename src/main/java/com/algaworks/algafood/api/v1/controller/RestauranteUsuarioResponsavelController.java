...
public class RestauranteUsuarioResponsavelController implements RestauranteUsuarioResponsavelControllerOpenApi {
	...
	public CollectionModel<UsuarioModel> listar(@PathVariable Long restauranteId) {
		...
		CollectionModel<UsuarioModel> usuariosModel = usuarioModelAssembler
						...
						.add(algaLinks.linkToRestauranteResponsavelAssociacao(restauranteId, "Associacao"));
		
		
		usuariosModel.getContent()
			.forEach(usuario -> {
				usuario.add(algaLinks.linkToRestauranteResponsavelDesassociacao(restauranteId, usuario.getId(), "desassociar"));
			});	
