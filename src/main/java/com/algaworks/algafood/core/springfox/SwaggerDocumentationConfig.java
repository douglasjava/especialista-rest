...
public class SwaggerDocumentationConfig implements WebMvcConfigurer {
	...
	public Docket apiDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
					...
					//.globalOperationParameters(getOperationParameters()) //adicionando parametros implicitos globalmente
	...
	private List<ResponseMessage> globalGetResponseMessages() {
		return Arrays.asList(
					new ResponseMessageBuilder()
						...
						.build(),
					new ResponseMessageBuilder()
						.code(HttpStatus.NOT_ACCEPTABLE.value())//pediu XML mas a API só retonar JSON
	...
	private List<ResponseMessage> globalPostPutResponseMessages() {
	    return Arrays.asList(
	            new ResponseMessageBuilder()
	                ...
	                .responseModel(new ModelRef("Problema"))// O nome usado aqui é a anotação @ApiModel("Problema") da classe utilizado
	                .build(),
	            new ResponseMessageBuilder()
	                .code(HttpStatus.INTERNAL_SERVER_ERROR.value())
	 ...
	 * 
	 * @param <T>
	 * @param typeResolver       -> new TypeResolver()
	 *                           <p>
	 * @param modelType          -> Classe original na qual queremos substituir
	 *                           <p>
	 * @param modelTypeOrigem    -> Classe de origem que usamos para substituir
	 *                           original
	 *                           <p>
	 * @param modelTypeAlternate -> Classe que ira substituir todo o retorno <b>exemplo: Page<CozinhaModel></b> <p>
	 * @return AlternateTypeRule
	 */
	private <T> AlternateTypeRule buildAlternate(TypeResolver typeResolver, Class<?> modelType, Class<?> modelTypeOrigem, Class<?> modelTypeAlternate) {
		return AlternateTypeRules.newRule(typeResolver.resolve(modelType, modelTypeOrigem), modelTypeAlternate);
	}
